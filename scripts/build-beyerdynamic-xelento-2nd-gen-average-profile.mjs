#!/usr/bin/env node
/** Build the Beyerdynamic Xelento 2nd Gen average-measurement FIR from AutoEq's published PEQ. */
...
const taps = 8192;
const outputPath = resolve("apps/web/public/headphone-compensation/beyerdynamic-xelento-2nd-gen-average-autoeq/average.f32");
// AutoEq HypetheSonics GRAS RA0045 result, revision 6c9a097. The source preamp
// is intentionally excluded: this FIR is normalized at 1 kHz and has no output trim.
const filters = [
  ["lowshelf", 105, 0.7, -1.9],
  ["peaking", 184, 0.73, -4.9],
  ["peaking", 1494, 1.57, -1.5],
  ["peaking", 2674, 1.05, 6],
  ["peaking", 3919, 3.15, 2.8],
  ["peaking", 60, 1.89, 0.3],
  ["peaking", 5342, 6, -2.4],
  ["peaking", 6152, 6, 2],
  ["peaking", 7507, 3.82, -1.4],
  ["highshelf", 10000, 0.7, 4.7],
];
