...
const leftOutput = wiring.find((edge) => edge.from === "profile-conv-0" && edge.to === "merge2" && edge.input === 0);
const rightOutput = wiring.find((edge) => edge.from === "profile-conv-1" && edge.to === "merge2" && edge.input === 1);
